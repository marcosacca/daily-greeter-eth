      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center space-x-2">
            ...
            <h1 className="text-xl font-bold text-primary-700">CryptoGreeter</h1>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden md:flex">
              <Button
                ...
                size="sm"
                className={`rounded-l-md rounded-r-none ${language === "it" ? "bg-primary text-white" : "bg-gray-100 text-gray-600"}`}
              ...
              <Button
                ...
                size="sm"
                className={`rounded-r-md rounded-l-none ${language === "en" ? "bg-primary text-white" : "bg-gray-100 text-gray-600"}`}
            ...
            {!account ? (
              ...
              <div className="flex items-center gap-2 py-1 px-3 bg-gray-100 rounded-md">
